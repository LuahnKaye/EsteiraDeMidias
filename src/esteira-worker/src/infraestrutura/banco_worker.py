...
# Configura a engine de conexões com o pool de conexões otimizado para o worker
...
def obter_sessao_worker():
    """
    Fornece um objeto Session de forma controlada para execução de operações.
    """
    return SessionLocal()
